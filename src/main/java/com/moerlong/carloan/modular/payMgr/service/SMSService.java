...
public interface SMSService {
    ...
    public static final String APPLY_TO_FAIL = "25";       //审核失败
    ...
    public static final String SUBMIT_SUCCESS= "58"; //审核成功
    public static final String SUBMIT_FAILD= "59"; //审核失败

    public static final String ALL_SUBMIT = "60"; //9.18新增
     ...
     * @return                true--成功
     */
    boolean sendMsgSMS(List<SendMsgVo> mobileList, String businessCode, Map<String, Object> msgParam);
}
