...
public class CustCompanyInfoController {

	private final Logger log = LoggerFactory.getLogger(CustCompanyInfoController.class);

	@Autowired
	CustCompanyInfoService service;
	@Autowired
	ApplyInfoService applyInfoService;

	@ApiOperation(value = "保存或更新")
	@ApiImplicitParam(paramType = "body", name = "entity", required = true, dataType = "CustCompanyInfo", value = "明细")
	@RequestMapping(value = "/custCompanyInfo/saveOrUpdate", method = RequestMethod.POST)
	@ResponseBody
	public Object saveOrUpdate(@RequestBody CustCompanyInfo entity) {
	...
	@ApiImplicitParam(paramType = "body", name = "entity", required = true, dataType = "CustCompanyInfo", value = "明细")
	@RequestMapping(value = "/custCompanyInfo/updateWithOutNull", method = RequestMethod.POST)
	@ResponseBody
	public Object updateWithOutNull(@RequestBody CustCompanyInfo entity) {
		Map<String, Object> res = new HashMap<>();
		try {
	...
	@RequestMapping(value = "/custCompanyInfo/deleteById", method = {RequestMethod.POST,RequestMethod.GET})
	@ResponseBody
	...
	@ApiImplicitParam(paramType = "body", name = "param", required = false, dataType = "Map", value = "参数")
	@RequestMapping(value = "/custCompanyInfo/deleteLogicById", method = {RequestMethod.POST,RequestMethod.GET})
	@ResponseBody
	...
	@ApiImplicitParam(paramType = "body", name = "param", required = false, dataType = "Map", value = "参数")
	@RequestMapping(value = "/custCompanyInfo/findById", method = {RequestMethod.POST,RequestMethod.GET})
	@ResponseBody
	...
	@RequestMapping(value = "/custCompanyInfo/listAll", method = {RequestMethod.POST,RequestMethod.GET})
	@ResponseBody
	...
	@RequestMapping(value = "/custCompanyInfo/pageQuery", method = RequestMethod.POST)
	@ResponseBody
	public Object pageQuery(@RequestBody Map<String,Object> queryMap) {
		this.log.info("/custCompanyInfo/pageQuery param:{}",queryMap);
		Map<String, Object> res = new HashMap<>();
	...
	@RequestMapping(value = "/custCompanyInfo/findByApplyIdAndType", method = {RequestMethod.POST,RequestMethod.GET})
	@ResponseBody
