...
public class TelecomFriendCircleController {
	...
	@Autowired
	TelecomFriendCircleService service;

	@ApiOperation(value = "保存或更新")
	@ApiImplicitParam(paramType = "body", name = "entity", required = true, dataType = "TelecomFriendCircle", value = "明细")
	@RequestMapping(value = "/telecomFriendCircle/saveOrUpdate", method = RequestMethod.POST)
	@ResponseBody
	public Object saveOrUpdate(@RequestBody TelecomFriendCircle entity) {
	...
	@ApiImplicitParam(paramType = "body", name = "entity", required = true, dataType = "TelecomFriendCircle", value = "明细")
	@RequestMapping(value = "/telecomFriendCircle/updateWithOutNull", method = RequestMethod.POST)
	@ResponseBody
	public Object updateWithOutNull(@RequestBody TelecomFriendCircle entity) {
		Map<String, Object> res = new HashMap<>();
		try {
	...
	@RequestMapping(value = "/telecomFriendCircle/deleteById", method = {RequestMethod.POST,RequestMethod.GET})
	@ResponseBody
	...
	@ApiImplicitParam(paramType = "body", name = "param", required = false, dataType = "Map", value = "参数")
	@RequestMapping(value = "/telecomFriendCircle/deleteLogicById", method = {RequestMethod.POST,RequestMethod.GET})
	@ResponseBody
	...
	@ApiImplicitParam(paramType = "body", name = "param", required = false, dataType = "Map", value = "参数")
	@RequestMapping(value = "/telecomFriendCircle/findById", method = {RequestMethod.POST,RequestMethod.GET})
	@ResponseBody
	...
	@RequestMapping(value = "/telecomFriendCircle/listAll", method = {RequestMethod.POST,RequestMethod.GET})
	@ResponseBody
	...
	@RequestMapping(value = "/telecomFriendCircle/pageQuery", method = RequestMethod.POST)
	@ResponseBody
	public Object pageQuery(@RequestBody Map<String,Object> queryMap) {
		this.log.info("/telecomFriendCircle/pageQuery param:{}",queryMap);
		Map<String, Object> res = new HashMap<>();
	...
	@RequestMapping(value = "/telecomFriendCircle/selectByApplyIdAndType", method = {RequestMethod.POST,RequestMethod.GET})
	@ResponseBody
	public Object selectByApplyIdAndType(@RequestParam Map<String,Object> param) {
		Map<String, Object> res = new HashMap<>();
		try {
