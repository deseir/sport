...
public class SQcAttachController {

	private final Logger log = LoggerFactory.getLogger(SQcAttachController.class);

	@Autowired
	SQcAttachService service;
	...
	@RequestMapping(value = "/sqcAttach/saveOrUpdate", method = RequestMethod.POST)
	@ResponseBody
	public Object saveOrUpdate(SQcAttach entity) {
		...
		try {
			...
			res.put("qcAttachId",entity.getId());
			res.put("status", 0);
			res.put("errMsg", "操作成功");
		} catch (Throwable e) {
	...
	@ApiImplicitParam(paramType = "body", name = "entity", required = true, dataType = "TelecomRoamInfo", value = "明细")
	@RequestMapping(value = "/sqcAttach/updateWithOutNull", method = RequestMethod.POST)
	@ResponseBody
	public Object updateWithOutNull(SQcAttach entity) {
		Map<String, Object> res = new HashMap<>();
		try {
			service.updateWithOutNull(entity);
			res.put("status", 0);
	...
	@RequestMapping(value = "/sqcAttach/deleteById", method = {RequestMethod.POST,RequestMethod.GET})
	@ResponseBody
	...
	@ApiImplicitParam(paramType = "body", name = "param", required = false, dataType = "Map", value = "参数")
	@RequestMapping(value = "/sqcAttach/deleteLogicById", method = {RequestMethod.POST,RequestMethod.GET})
	@ResponseBody
	...
	@ApiImplicitParam(paramType = "body", name = "param", required = false, dataType = "Map", value = "参数")
	@RequestMapping(value = "/sqcAttach/findById", method = {RequestMethod.POST,RequestMethod.GET})
	@ResponseBody
	...
	@RequestMapping(value = "/sqcAttach/listAll", method = {RequestMethod.POST,RequestMethod.GET})
	@ResponseBody
	...
	@RequestMapping(value = "/sqcAttach/pageQuery", method = RequestMethod.POST)
	@ResponseBody
	public Object pageQuery(@RequestParam Map<String,Object> queryMap) {
		this.log.info("/sqcAttach/pageQuery param:{}",queryMap);
		Map<String, Object> res = new HashMap<>();
