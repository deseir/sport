...
//@RestController
//@RequestMapping("/carMultimediaConfig")
public class CarMultimediaConfigController {

    private final Logger LOG = LoggerFactory.getLogger(CarMultimediaConfigController.class);

    @Autowired
    private CarMultimediaConfigService service;
    @Autowired
    private ApplyInfoService applyInfoService;

    @ApiOperation(value = "保存或更新")
    @ApiImplicitParam(paramType = "body", name = "entity", required = true, dataType = "CarMultimediaConfig")
    @RequestMapping(value = "/saveOrUpdate")
    public Object saveOrUpdate(@RequestBody CarMultimediaConfig entity) {
