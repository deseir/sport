...
public class CarInsureDetailInfoController {
	...
	@Autowired
	CarInsureDetailInfoService service;

	@ApiOperation(value = "保存或更新")
	@ApiImplicitParam(paramType = "body", name = "entity", required = true, dataType = "CarInsureDetailInfo", value = "明细")
	@RequestMapping(value = "/carInsureDetailInfo/saveOrUpdate", method = RequestMethod.POST)
	@ResponseBody
	public Object saveOrUpdate(@RequestBody CarInsureDetailInfo entity) {
	...
	@ApiImplicitParam(paramType = "body", name = "entity", required = true, dataType = "CarInsureDetailInfo", value = "明细")
	@RequestMapping(value = "/carInsureDetailInfo/updateWithOutNull", method = RequestMethod.POST)
	@ResponseBody
	public Object updateWithOutNull(@RequestBody CarInsureDetailInfo entity) {
		Map<String, Object> res = new HashMap<>();
		try {
	...
	@RequestMapping(value = "/carInsureDetailInfo/deleteById", method = {RequestMethod.POST,RequestMethod.GET})
	@ResponseBody
	...
	@ApiImplicitParam(paramType = "body", name = "param", required = false, dataType = "Map", value = "参数")
	@RequestMapping(value = "/carInsureDetailInfo/deleteLogicById", method = {RequestMethod.POST,RequestMethod.GET})
	@ResponseBody
	...
	@ApiImplicitParam(paramType = "body", name = "param", required = false, dataType = "Map", value = "参数")
	@RequestMapping(value = "/carInsureDetailInfo/findById", method = {RequestMethod.POST,RequestMethod.GET})
	@ResponseBody
	...
	@RequestMapping(value = "/carInsureDetailInfo/listAll", method = {RequestMethod.POST,RequestMethod.GET})
	@ResponseBody
	...
	@RequestMapping(value = "/carInsureDetailInfo/pageQuery", method = RequestMethod.POST)
	@ResponseBody
	public Object pageQuery(@RequestBody Map<String,Object> queryMap) {
		this.log.info("/carInsureDetailInfo/pageQuery param:{}",queryMap);
		Map<String, Object> res = new HashMap<>();
