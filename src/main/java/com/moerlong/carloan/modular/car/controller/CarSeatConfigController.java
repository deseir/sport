...
public class CarSeatConfigController {
    ...
    @Autowired
    private CarSeatConfigService service;
    @Autowired
    private ApplyInfoService applyInfoService;

    @ApiOperation(value = "保存或更新")
    @ApiImplicitParam(paramType = "body", name = "entity", required = true, dataType = "CarSeatConfig")
    @RequestMapping(value = "/saveOrUpdate")
    public Object saveOrUpdate(@RequestBody CarSeatConfig entity) {
