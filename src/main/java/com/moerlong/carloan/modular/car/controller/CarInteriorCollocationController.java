...
@RestController
@RequestMapping("/carInteriorCollocation")
public class CarInteriorCollocationController {


    private final Logger LOG = LoggerFactory.getLogger(CarInteriorCollocationController.class);

    @Autowired
    private CarInteriorCollocationService service;
    @Autowired
    private ApplyInfoService applyInfoService;

    @ApiOperation(value = "保存或更新")
    @ApiImplicitParam(paramType = "body", name = "entity", required = true, dataType = "CarInteriorCollocation")
    @RequestMapping(value = "/saveOrUpdate",method={RequestMethod.POST,RequestMethod.GET})
    public Object saveOrUpdate(@RequestBody CarInteriorCollocation entity) {
