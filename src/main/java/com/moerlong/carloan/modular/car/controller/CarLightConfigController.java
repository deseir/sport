...
@RestController
@RequestMapping("/carLightConfig")
public class CarLightConfigController {

    private final Logger LOG = LoggerFactory.getLogger(CarLightConfigController.class);

    @Autowired
    private CarLightConfigService service;
    @Autowired
    private ApplyInfoService applyInfoService;

    @ApiOperation(value = "保存或更新")
    @ApiImplicitParam(paramType = "body", name = "entity", required = true, dataType = "CarLightConfig")
    @RequestMapping(value = "/saveOrUpdate",method={RequestMethod.POST,RequestMethod.GET})
    public Object saveOrUpdate(@RequestBody CarLightConfig entity) {
