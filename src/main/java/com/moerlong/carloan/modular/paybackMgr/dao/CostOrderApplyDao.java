...
public interface CostOrderApplyDao {
	 ...
	 * @return
	 */
	public List<CostOrderApply> selectPage( @Param("orderCondition") String orderCondition);

	/**
	 * 根据条件查询审核订单
	 * @return
	 */
	public List<CostOrderApply> listByCondition(@Param("batchNo")String batchNo, @Param("beginTime")String beginTime, @Param("endTime")String endTime, @Param("status")String status);
