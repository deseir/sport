...
public class RoleApplyController {
	...
	private final Logger log = LoggerFactory.getLogger(RoleApplyController.class);

	@Autowired
	RoleApplyService service;

	@ApiOperation(value = "保存或更新")
	@ApiImplicitParam(paramType = "body", name = "entity", required = true, dataType = "RoleApply", value = "明细")
	@RequestMapping(value = "/roleApply/saveOrUpdate", method = RequestMethod.POST)
	@ResponseBody
	public Object saveOrUpdate(@RequestBody RoleApply entity) {
	...
	@ApiImplicitParam(paramType = "body", name = "entity", required = true, dataType = "RoleApply", value = "明细")
	@RequestMapping(value = "/roleApply/updateWithOutNull", method = RequestMethod.POST)
	@ResponseBody
	public Object updateWithOutNull(@RequestBody RoleApply entity) {
		Map<String, Object> res = new HashMap<>();
		try {
	...
	@RequestMapping(value = "/roleApply/deleteById", method = {RequestMethod.POST,RequestMethod.GET})
	@ResponseBody
	...
	@ApiImplicitParam(paramType = "body", name = "param", required = false, dataType = "Map", value = "参数")
	@RequestMapping(value = "/roleApply/deleteLogicById", method = {RequestMethod.POST,RequestMethod.GET})
	@ResponseBody
	...
	@ApiImplicitParam(paramType = "body", name = "param", required = false, dataType = "Map", value = "参数")
	@RequestMapping(value = "/roleApply/findById", method = {RequestMethod.POST,RequestMethod.GET})
	@ResponseBody
	...
	@RequestMapping(value = "/roleApply/listAll", method = {RequestMethod.POST,RequestMethod.GET})
	@ResponseBody
	...
	@RequestMapping(value = "/roleApply/pageQuery", method = RequestMethod.POST)
	@ResponseBody
	public Object pageQuery(@RequestBody Map<String,Object> queryMap) {
		this.log.info("/roleApply/pageQuery param:{}",queryMap);
		Map<String, Object> res = new HashMap<>();
