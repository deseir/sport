...
public class BankcardInfoController {
	...
	private final Logger log = LoggerFactory.getLogger(BankcardInfoController.class);

	@Autowired
	BankcardInfoService service;

	@ApiOperation(value = "保存或更新")
	@ApiImplicitParam(paramType = "body", name = "entity", required = true, dataType = "BankcardInfo", value = "明细")
	@RequestMapping(value = "/bankcardInfo/saveOrUpdate", method = RequestMethod.POST)
	@ResponseBody
	public Object saveOrUpdate(@RequestBody BankcardInfo entity) {
	...
	@ApiImplicitParam(paramType = "body", name = "entity", required = true, dataType = "BankcardInfo", value = "明细")
	@RequestMapping(value = "/bankcardInfo/updateWithOutNull", method = RequestMethod.POST)
	@ResponseBody
	public Object updateWithOutNull(@RequestBody BankcardInfo entity) {
		Map<String, Object> res = new HashMap<>();
		try {
	...
	@RequestMapping(value = "/bankcardInfo/deleteById", method = {RequestMethod.POST,RequestMethod.GET})
	@ResponseBody
	...
	@ApiImplicitParam(paramType = "body", name = "param", required = false, dataType = "Map", value = "参数")
	@RequestMapping(value = "/bankcardInfo/deleteLogicById", method = {RequestMethod.POST,RequestMethod.GET})
	@ResponseBody
	...
	@ApiImplicitParam(paramType = "body", name = "param", required = false, dataType = "Map", value = "参数")
	@RequestMapping(value = "/bankcardInfo/findById", method = {RequestMethod.POST,RequestMethod.GET})
	@ResponseBody
	...
	@RequestMapping(value = "/bankcardInfo/listAll", method = {RequestMethod.POST,RequestMethod.GET})
	@ResponseBody
	...
	@RequestMapping(value = "/bankcardInfo/pageQuery", method = RequestMethod.POST)
	@ResponseBody
	public Object pageQuery(@RequestBody Map<String,Object> queryMap) {
		this.log.info("/bankcardInfo/pageQuery param:{}",queryMap);
		Map<String, Object> res = new HashMap<>();
