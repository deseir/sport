...
import com.moerlong.carloan.modular.system.factory.UserFactory;
import com.moerlong.carloan.modular.system.transfer.UserDto;
import com.moerlong.carloan.modular.system.warpper.UserWarpper;
...
//    @BussinessLog(value = "分配角色", key = "userId,roleIds", dict = Dict.UserDict)
    ...
    public String upload(@RequestPart("file") MultipartFile picture) {
        ...
        try {
            String fileSavePath = fundProperties.getFileUploadPath();
    ...
    private void assertAuth(Integer userId) {
        ...
        for(String deptid : deptids.split(",")){
            if (deptDataScope.contains(Integer.parseInt(deptid))) {
                continue;
            } else {
                throw new BussinessException(BizExceptionEnum.NO_PERMITION);
            }
