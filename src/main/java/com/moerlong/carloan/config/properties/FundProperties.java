...
import static com.moerlong.carloan.core.util.ToolUtil.getTempPath;
import static com.moerlong.carloan.core.util.ToolUtil.isEmpty;
 ...
 */
@Component
@ConfigurationProperties(prefix = FundProperties.PREFIX)
