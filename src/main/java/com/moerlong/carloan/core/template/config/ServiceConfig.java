package com.moerlong.carloan.core.template.config;
...
public class ServiceConfig {
    ...
    public void init() {
        ...
        imports.add("com.moerlong.carinsure.modular." + contextConfig.getModuleName() + ".service.I" + contextConfig.getBizEnBigName() + "Service");
        this.serviceImplImports = imports;
        this.servicePathTemplate = "\\src\\main\\java\\com\\moerlong\\carinsure\\modular\\" + contextConfig.getModuleName() + "\\service\\I{}Service.java";
        this.serviceImplPathTemplate = "\\src\\main\\java\\com\\moerlong\\carinsure\\modular\\" + contextConfig.getModuleName() + "\\service\\impl\\{}ServiceImpl.java";
        this.packageName = "com.moerlong.carinsure.modular." + contextConfig.getModuleName() + ".service";
    }
