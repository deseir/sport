package com.moerlong.carloan.core.template.engine.base;
 ...
 */
public abstract class FundTemplateEngine extends AbstractTemplateEngine {

    protected GroupTemplate groupTemplate;

    public FundTemplateEngine() {
        initBeetlEngine();
    }
