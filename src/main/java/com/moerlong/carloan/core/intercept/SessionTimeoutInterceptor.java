package com.moerlong.carloan.core.intercept;
...
@Aspect
@Component
@ConditionalOnProperty(prefix = "fund", name = "session-open", havingValue = "true")
public class SessionTimeoutInterceptor extends BaseController {

    @Pointcut("execution(* com.moerlong.carloan.*..controller.*.*(..))")
