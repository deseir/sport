...
import com.moerlong.carloan.common.constant.tips.ErrorTip;
...
import static com.moerlong.carloan.core.support.HttpKit.getRequest;
...
public class GlobalExceptionHandler {
    ...
    public String unAuth(AuthenticationException e) {
        log.error("用户未登陆：", e);
        String flag = (String)ShiroKit.getSession().getAttribute("qhFlag");
        if("1".equals(flag)){
            return "/login.html";
