...
import com.moerlong.carloan.common.constant.cache.CacheKey;
...
public interface IConstantFactory {
    ...
    String getSingleDeptName(Integer deptId);

    /**
     * 通过部门deptids获取部门名称
     */
    @Cacheable(value = Cache.CONSTANT, key = "'" + CacheKey.DEPT_NAME + "'+#deptIds")
