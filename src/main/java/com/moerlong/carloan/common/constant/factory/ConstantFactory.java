...
import com.moerlong.carloan.core.support.StrKit;
...
import com.moerlong.carloan.common.persistence.dao.MenuMapper;
...
import com.moerlong.carloan.common.persistence.model.Menu;
...
//    private RoleMapper roleMapper = SpringContextHolder.getBean(RoleMapper.class);
    ...
    public String getDeptName(String deptIds) {
        ...
        StringBuilder sb = new StringBuilder();
        for (int dept : depts) {
            Dept deptObj = deptMapper.selectById(dept);
            if (ToolUtil.isNotEmpty(deptObj) && ToolUtil.isNotEmpty(deptObj.getFullname())) {
     ...
     */
    @Override
    public String getSingleDeptName(Integer deptId) {
