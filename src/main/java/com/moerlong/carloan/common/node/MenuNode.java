package com.moerlong.carloan.common.node;

import com.moerlong.carloan.common.constant.state.IsMenu;
...
public class MenuNode implements Comparable {
    ...
    public static List<MenuNode> buildTitle(List<MenuNode> nodes) {
        ...
        FundProperties fundProperties = SpringContextHolder.getBean(FundProperties.class);
