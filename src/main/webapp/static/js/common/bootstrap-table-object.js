            ...
            this.btInstance =
                $('#' + tableId).bootstrapTable({
                    ...
                    responseHandler: function(res) {
                        //后端分页过滤 收款记录、统计报表、还款计划查询
                        if(this.url.lastIndexOf('/payStatisInfo/list')>=0 ||
                            this.url.lastIndexOf('/repaymentPlanInfo/queryRecePay')>=0 ||
                            this.url.lastIndexOf('/repaymentPayInfo/list')>=0||
                            this.url.lastIndexOf('/payDetailInfo/list')>=0||
                            this.url.lastIndexOf('/loanApply/list')>=0||
