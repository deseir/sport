...
(function() {
    ...
    CSSLint.addFormatter({
        ...
        readError: function(filename, message) {
            return "<file name=\"" + xmlEscape(filename) + "\"><error line=\"0\" column=\"0\" severty=\"error\" message=\"" + xmlEscape(message) + "\"></error><${ctxPath}/static/qianduan/>";
        },
        formatResults: function(results, filename/*, options*/) {
            ...
            if (messages.length > 0) {
                ...
                output.push("<${ctxPath}/static/qianduan/>");
            }
